...
def convert_to_trtllm_request(
    ...
    max_attend_count = 8
    max_end_attend_count = 16
    short_text_threshold = int(os.environ.get("MAGPIE_SHORT_TEXT_ENCODER_LEN_THRESHOLD", "6"))
    if work_item.encoder_left_offset > 0 and real_encoder_len <= short_text_threshold:
        ...
        max_end_attend_count = int(os.environ.get("MAGPIE_SHORT_TEXT_MAX_END_ATTEND_COUNT", "4"))
    pb_utils.Logger.log_verbose(
        ...
        f"left_offset={left_offset} real_encoder_len={real_encoder_len} "
